...
{
    public function __construct(private string $manifestUrl='https://github.com/tihloh/vendogate-firmware-releases/releases/latest/download/manifest.json',private int $cacheSeconds=300) {}

...
final class PdoDeviceRepository implements DeviceRepository
{
    ...
    private function map(array $r): Device{return new Device($r['device_id'],$r['hardware_uid']?:null,$r['state'],$r['hardware_model']?:null,$r['hardware_revision']?:null,$r['firmware_version']?:null,$r['last_seen_at']?new \DateTimeImmutable($r['last_seen_at'],new \DateTimeZone('UTC')):null);}
}

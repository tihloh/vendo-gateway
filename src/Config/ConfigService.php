...
final class ConfigService
{
    ...
    public function pull(string $deviceId,?string $currentRevision=null): array{$r=$this->resolve($deviceId);if($currentRevision!==null&&hash_equals($r['revision'],$currentRevision))return ['changed'=>false,'revision'=>$r['revision'],'version'=>$r['version'],'profile_version'=>$r['profile_version']];return ['changed'=>true,...$r];}
